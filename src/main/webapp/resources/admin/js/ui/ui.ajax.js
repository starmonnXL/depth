 ...
 * @param url
 */
function formExport(from,url){
	var fromParams = $(from).serializeArray();
	var pm={};

	for(key in fromParams){
		pm[fromParams[key].name] = fromParams[key].value;
	}
