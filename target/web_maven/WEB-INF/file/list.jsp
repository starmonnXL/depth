...
<body>
		...
		<div class="serch-box" id="table-bar">
			...
			<!-- 操作栏 start -->
			<div>
				 <a href="javascript:void(0)" class="easyui-linkbutton data-author" data-code="ADD" iconCls="icon-add" plain="true" onclick="window.parent.addNewTab('0000000003','<%=basePath%>file/addInput.do','文件上传')">上传文件</a>
		         <a href="javascript:void(0)" class="easyui-linkbutton data-author" data-code="DELETE" iconCls="icon-remove" plain="true" id="deleteCode">删除</a>
			</div>
			<!-- 操作栏 end -->
		</div>
		<!-- 搜索 end -->
		...
		<table id="file-datagrid" >
			<thead>
				<tr>
					<th data-options="field:'id'" width="100">文件编号</th>
