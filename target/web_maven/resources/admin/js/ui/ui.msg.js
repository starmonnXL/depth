	...
	show:function(options){
		if(options.msgType){
			if(options.msgType=="warning"){
				options.msg='<div style="font-weight: bold;"><img src="resources/admin/js/ui/images/msg/messager_warning.gif"/>&nbsp;&nbsp;'+options.msg+"</div>";
			}else if(options.msgType=="success"){
				options.msg='<div><img src="resources/admin/js/ui/images/msg/Check_32x32.png"/>&nbsp;&nbsp;'+options.msg+"</div>";
